...
const TIPO_CONFIG = {
  ...
  pedido_fechado:     { icon: 'solar:wallet-money-linear', cor: 'text-green-700 dark:text-green-400',   bg: 'bg-green-100 dark:bg-green-400/10',   border: 'border-green-300 dark:border-green-400/20'  },
    ...
    <div className="page-enter bg-zinc-50 dark:bg-[#050505] text-zinc-700 dark:text-[#a1a1aa] min-h-screen font-sans">
      <main className="max-w-[1100px] mx-auto p-6 md:p-8">
        ...
        <div className="sys-reveal flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="text-[10px] font-mono text-zinc-500 dark:text-white mb-2 uppercase tracking-widest border border-zinc-200/80 dark:border-zinc-800 bg-white/50 dark:bg-transparent backdrop-blur-md w-max px-2.5 py-1 rounded-md dark:rounded-none shadow-sm dark:shadow-none">Admin // Notificações</div>

...
export default function MenuAcoesCheque({
  ...
  return (
    <>
      ...
      {aberto && createPortal(
        <div
          className="fixed z-[200] bg-white/90 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 shadow-sm shadow-zinc-100/60 dark:shadow-none rounded-[2rem] dark:rounded-none min-w-[180px] py-1"

...
const INPUT_BASE =
  ...
  'focus:border-orange-500 dark:focus:border-yellow-400 transition-colors w-full [color-scheme:dark]';
...
export default function ModalRepassarCheque({
  ...
  return (
    ...
    >
      <div
        className="bg-white/95 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 rounded-2xl dark:rounded-none shadow-sm shadow-zinc-100/60 dark:shadow-2xl w-full max-w-sm mx-4"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
          ...
          {/* Resumo */}
          <div className="border border-zinc-200/80 dark:border-zinc-800 px-4 py-3 flex flex-col gap-1">
            <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600">Cheque nº {cheque.numero_cheque}</span>
            <span className="text-zinc-900 dark:text-white text-sm">{cheque.titular}</span>
            <span className="font-mono text-sm tabular-nums text-zinc-900 dark:text-white">{formatBRL(cheque.valor)}</span>
          </div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              ...
              onClick={onFechar}
              disabled={salvando}
              className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-900 dark:hover:text-white transition-colors border border-zinc-200/80 dark:border-zinc-800 px-4 py-2"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={salvando}
              className="font-mono text-[9px] uppercase tracking-widest bg-orange-500 dark:bg-yellow-400 text-white dark:text-black rounded-xl dark:rounded-none px-4 py-2 hover:bg-orange-600 dark:hover:bg-yellow-300 transition-colors disabled:opacity-50"
            >

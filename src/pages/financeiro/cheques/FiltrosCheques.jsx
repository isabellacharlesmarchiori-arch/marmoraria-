...
export default function FiltrosCheques({ filtros, setFiltros }) {
  ...
  return (
    <div className="border border-zinc-800 bg-[#0a0a0a] p-4 flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-600">Bom pra</span>
        <input
          type="date"
        ...
        <button
          type="button"
          onClick={limpar}
          className="font-mono text-[9px] uppercase tracking-widest text-zinc-600 hover:text-zinc-400 transition-colors ml-auto whitespace-nowrap"
        >
          Limpar filtros
        </button>
      </div>

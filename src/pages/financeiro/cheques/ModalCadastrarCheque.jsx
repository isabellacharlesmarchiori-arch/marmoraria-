...
function Secao({ label }) {
  return (
    <div className="flex items-center gap-3 my-2">
      <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600 border border-zinc-200/80 dark:border-zinc-800 px-2 py-0.5">
        {label}
      </span>
...
export default function ModalCadastrarCheque({
  ...
  return (
    ...
    >
      <div
        className="bg-white/95 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 rounded-2xl dark:rounded-none shadow-sm shadow-zinc-100/60 dark:shadow-2xl w-full max-w-lg mx-4"
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
            ...
            {[
              ...
              <label key={v} className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="accent-orange-500 dark:accent-yellow-400"
                />
                <span className="text-sm text-zinc-600 dark:text-zinc-300">{l}</span>
              </label>
            ))}
          </div>
          ...
          <Campo label="Valor" required>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 font-mono text-[10px] text-zinc-500 dark:text-zinc-500">R$</span>
              <input
                type="number"
                min="0.01"
                step="0.01"

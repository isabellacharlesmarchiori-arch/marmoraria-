    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline gap-2">
          <span className="font-mono text-[9px] text-zinc-500 dark:text-zinc-600 shrink-0">{dataDisplay}</span>
          <span className="text-sm text-zinc-900 dark:text-white truncate">{lancamento.descricao}</span>
        </div>
        {linhaSecundaria && (
          <p className="font-mono text-[9px] text-zinc-500 dark:text-zinc-600 mt-0.5 truncate">{linhaSecundaria}</p>
        )}
      </div>

...
const INPUT = 'bg-white dark:bg-[#0a0a0a] border border-zinc-200/80 dark:border-zinc-800 px-3 py-2 text-sm text-zinc-900 dark:text-white outline-none focus:border-orange-500 dark:focus:border-yellow-400 rounded-md dark:rounded-none transition-colors w-full';
...
export default function CamposParcelamento({
  ...
  return (
    <div className="border border-zinc-200/80 dark:border-zinc-800 flex flex-col gap-4 p-4">
      ...
      <div className="flex gap-3 flex-wrap">
        <button
          ...
          className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500 hover:text-orange-600 dark:hover:text-yellow-400 transition-colors border border-zinc-200/80 dark:border-zinc-800 px-3 py-1.5"
        >

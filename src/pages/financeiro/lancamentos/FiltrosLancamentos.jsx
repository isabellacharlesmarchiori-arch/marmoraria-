    ...
    <div className="border border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600 mr-1">Tipo</span>
          {[
            { v: 'todos',   l: 'Todos'  },
            { v: 'entrada', l: 'Entrada' },
            { v: 'saida',   l: 'Saída'  },
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600">Período por</span>

            <select
              value={filtros.campoData}
              onChange={e => setFiltros({ ...filtros, campoData: e.target.value })}
              className="bg-white dark:bg-[#0a0a0a] border border-zinc-200/80 dark:border-zinc-800 px-2 py-1 font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500 outline-none focus:border-orange-500 dark:focus:border-yellow-400 rounded-md dark:rounded-none cursor-pointer transition-colors"
            >
            ...
            <div className="flex items-center border border-zinc-200/80 dark:border-zinc-800 overflow-hidden">
                ...
                <button
                  ...
                  className={`px-3 py-1 font-mono text-[9px] uppercase tracking-widest transition-colors ${
                    filtros.modoPeriodo === v
                      ? 'bg-orange-500 dark:bg-yellow-400 text-white dark:text-black rounded-xl dark:rounded-none'
                      : 'text-zinc-500 dark:text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300'
                  }`}
                >
                  {l}
                </button>
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              >
                {temFiltroAvancado && !avancadoAberto && (
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-500 dark:bg-yellow-400 inline-block" />
                )}
              ...
              <button
                type="button"
                onClick={limpar}
                className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600 hover:text-zinc-500 dark:hover:text-zinc-400 transition-colors"
              >
                Limpar
              </button>
            </div>
      ...
      {/* Painel avançado */}
      {avancadoAberto && (
        <div className="border-t border-zinc-200/80 dark:border-zinc-800 p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">

...
const CHIP_ON   = 'border-orange-500 dark:border-yellow-400 text-orange-600 dark:text-yellow-400';
const CHIP_OFF  = 'border-zinc-200/80 dark:border-zinc-800 text-zinc-500 dark:text-zinc-500 hover:border-zinc-300 dark:hover:border-zinc-600';
  ...
  return (
    <div className="flex flex-col gap-1">
      <div className="flex items-baseline gap-2">
        <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500">{label}</span>
        {hint && <span className="font-mono text-[8px] text-zinc-400 dark:text-zinc-700">{hint}</span>}
      </div>
      {children}
    </div>
  );
...
export default function ModalLancamentoForm({
  ...
  return (
    ...
    >
      <div
        className="bg-white/95 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 rounded-2xl dark:rounded-none shadow-sm shadow-zinc-100/60 dark:shadow-2xl w-full max-w-2xl max-h-full overflow-y-auto"
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-zinc-200/80 dark:border-zinc-800 flex items-center justify-between sticky top-0 bg-white dark:bg-[#0a0a0a] z-10">
          ...
          <button type="button" onClick={onFechar} className="text-zinc-500 dark:text-zinc-600 hover:text-zinc-900 dark:hover:text-zinc-900 dark:hover:text-white transition-colors">
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
          ...
          {ehGrupo && (
            <div className="border border-amber-900/40 bg-amber-950/15 px-4 py-3 flex flex-col gap-2">
              ...
              {escopoEdicao !== 'esta' && (
                <p className="font-mono text-[8px] text-zinc-500 dark:text-zinc-600">
          ...
          <div className="flex flex-col gap-2">
            <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500">Tipo</span>
          ...
          <div className="border border-zinc-200/80 dark:border-zinc-800 p-4 flex flex-col gap-4">
            ...
            <div className="flex items-baseline justify-between pt-2 border-t border-zinc-200/80 dark:border-zinc-800">
              <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-500">
              ...
              <span className={`font-mono text-xl font-bold tabular-nums tracking-tight ${
                valorTotal > 0 ? 'text-orange-600 dark:text-yellow-400' : 'text-zinc-400 dark:text-zinc-700'
              }`}>
          ...
          <p className="font-mono text-[8px] text-zinc-400 dark:text-zinc-700 leading-relaxed">
            Todo lançamento é criado como <span className="text-zinc-500 dark:text-zinc-500">pendente</span>.
          ...
          <div className="flex items-center justify-between pt-2 border-t border-zinc-200/80 dark:border-zinc-800">
            ...
            <div className="flex items-center gap-4">
              {multiParcelas && !editando && (
                <span className="font-mono text-[8px] text-zinc-500 dark:text-zinc-600">

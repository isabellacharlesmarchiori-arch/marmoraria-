  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 px-3 py-2 w-full text-left font-mono text-[10px] uppercase tracking-widest transition-colors hover:bg-white/[0.015] ${
        destrutivo ? 'text-zinc-500 dark:text-zinc-400 hover:text-red-400' : 'text-zinc-900 dark:text-white hover:text-orange-600 dark:hover:text-yellow-400'
      }`}
    >
  ...
  return (
    <>
      <button
        ...
        className="text-zinc-500 dark:text-zinc-600 hover:text-orange-600 dark:hover:text-yellow-400 transition-colors"
      >
      ...
      {aberto && createPortal(
        <div
          className="fixed z-[200] bg-white/90 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 shadow-sm shadow-zinc-100/60 dark:shadow-none rounded-[2rem] dark:rounded-none min-w-[200px] py-1"
        ...
        >
          ...
          {temGrupo && (
            <>
              <div className="border-t border-zinc-200/80 dark:border-zinc-800 my-1" />
              <ItemMenu
                icon="lucide:layers"

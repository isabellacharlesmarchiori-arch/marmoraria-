...
const INPUT =
  'bg-white dark:bg-[#0a0a0a] border border-zinc-200/80 dark:border-zinc-800 px-2 py-1.5 text-sm text-zinc-900 dark:text-white outline-none ' +
  'focus:border-orange-500 dark:focus:border-yellow-400 transition-colors w-full';

const TH = 'px-3 py-2 font-mono text-[9px] uppercase tracking-widest text-zinc-500 dark:text-zinc-600 text-left';
    ...
    <div className="flex flex-col gap-2">
      <div className="border border-zinc-200/80 dark:border-zinc-800 overflow-x-auto">
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-950">
          ...
          <tbody>
            {parcelas.map((p, i) => (
              <tr key={i} className="border-b border-zinc-200/80 dark:border-zinc-900 hover:bg-zinc-200/20 dark:hover:bg-zinc-900/20">
          ...
          {parcelas.length > 0 && (
            <tfoot>
              <tr className="border-t border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-950">
                ...
                <td className="px-3 py-2 text-right">
                  <span className={`font-mono text-sm font-bold tabular-nums ${
                    temTotal && !bate ? 'text-amber-400' : 'text-zinc-900 dark:text-white'
                  }`}>
                    {formatBRL(somaTotal)}
                  </span>
                </td>

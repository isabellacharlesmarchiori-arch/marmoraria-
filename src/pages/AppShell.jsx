...
const AppShell = ({ children, perfil = 'vendedor', notifCount = 0 }) => {
  ...
  const perfilLabel = perfil === 'vendedor' ? 'Vendedora' : 
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#050505] text-white font-sans selection:bg-white selection:text-black">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-t border-zinc-800 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[11px] text-white font-medium truncate">Ana Silva</div>
      ...
      <main className="flex-1 flex flex-col min-w-0 relative z-10 w-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-7 sys-reveal sys-active">
          {children ? (
            children
          ) : (
             <div className="h-full flex items-center justify-center">
              <div className="text-center">
                <div className="text-[10px] font-mono uppercase tracking-widest text-zinc-800 mb-4">
                  02 // Content Area
                </div>
                <iconify-icon icon="solar:layers-linear" width="40" className="text-zinc-800 mb-4 block mx-auto"></iconify-icon>
                <div className="text-zinc-700 font-mono text-[11px] uppercase tracking-widest">

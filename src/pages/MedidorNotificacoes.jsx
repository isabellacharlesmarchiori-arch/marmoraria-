    ...
    <div className="page-enter bg-zinc-50 dark:bg-[#050505] text-zinc-700 dark:text-[#a1a1aa] min-h-screen font-sans">
      <main className="max-w-[1100px] mx-auto p-6 md:p-8">
        ...
        <div className="sys-reveal flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="text-[10px] font-mono text-zinc-500 dark:text-white mb-2 uppercase tracking-widest border border-zinc-200/80 dark:border-zinc-800 bg-white/50 dark:bg-transparent backdrop-blur-md w-max px-2.5 py-1 rounded-md dark:rounded-none shadow-sm dark:shadow-none">Notificações</div>
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-bold text-zinc-900 dark:text-white tracking-tight uppercase">Avisos</h1>
              {naoLidas > 0 && (
        ...
        {loading ? (
          ...
          <div className="bg-white/90 dark:bg-[#0a0a0a] backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800 shadow-xl shadow-zinc-200/40 dark:shadow-none rounded-[2rem] dark:rounded-none py-16 text-center">
            ...
            <p className="font-mono text-[11px] uppercase tracking-widest text-zinc-400 dark:text-zinc-700">Nenhum aviso</p>
          </div>
        ) : (

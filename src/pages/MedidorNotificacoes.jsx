...
export default function MedidorNotificacoes() {
  ...
  return (
    <div className="bg-[#050505] text-[#a1a1aa] min-h-screen">
      ...
      {/* Cabeçalho */}
      <div className="px-6 pt-6 pb-4 border-b border-zinc-800 flex items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-semibold text-white tracking-tight">Avisos</h1>
            {naoLidas > 0 && (
      ...
      <div className="px-6 py-4">
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="font-mono text-[11px] uppercase tracking-widest text-zinc-700">Nenhum aviso</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-end gap-1.5 shrink-0">
                    <span className="font-mono text-[9px] text-zinc-600 whitespace-nowrap">{formatarData(n.created_at)}</span>
                    {!n.lida && (

                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <section className="md:col-span-3 sys-reveal sys-delay-100">
                        ...
                        <div className="bg-[#0a0a0a] border border-zinc-800">
                            ...
                            <div className="px-4 py-3 border-t border-zinc-800">
                                <a href="/projetos" className="font-mono text-[10px] uppercase tracking-widest text-zinc-600 hover:text-yellow-400 transition-colors flex items-center gap-2 w-max">
                    ...
                    <section className="md:col-span-2 sys-reveal sys-delay-200">
                        ...
                        <div className="bg-[#0a0a0a] border border-zinc-800 h-full flex flex-col justify-between">
                            ...
                            <div className="px-4 py-3 border-t border-zinc-800">
                                <a href="/notificacoes" className="font-mono text-[10px] uppercase tracking-widest text-zinc-600 hover:text-yellow-400 transition-colors flex items-center gap-2 w-max">

                        ...
                        <div>
                            ...
                            <div className="relative">
                                <iconify-icon
                                    ...
                                    className={`absolute left-3 top-3.5 ${endConfirmado ? 'text-green-400' : 'text-zinc-500 dark:text-zinc-600'}`}
                                    width="14"
                                ></iconify-icon>
                                {endBuscando && (
                                    <iconify-icon
                                ...
                                {endSugestoes.length > 0 && (
                                    <div className="absolute top-full left-0 right-0 z-50 bg-zinc-100 dark:bg-[#0a0a0a] border border-zinc-200/80 dark:border-zinc-700 border-t-0 shadow-2xl max-h-56 overflow-y-auto">
                                                ...
                                                >
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            {s.type && (
                                                                <div className="font-mono text-[9px] text-zinc-500 dark:text-zinc-600 uppercase mt-0.5">
                                                                    {s.type}
                                                                </div>
                                                            )}
                                                        </div>

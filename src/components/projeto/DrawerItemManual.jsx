...
export default function DrawerItemManual({ itemManualEmEdicao, setItemManualEmEdicao, onSalvar }) {
    ...
    return (
        <>
            ...
            <div className="fixed right-0 top-0 h-full w-full max-w-[420px] bg-white/95 dark:bg-[#0a0a0a] backdrop-blur-xl border-l border-zinc-200/80 dark:border-zinc-800 shadow-xl shadow-zinc-200/40 dark:shadow-none z-50 flex flex-col overflow-hidden">
                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200/80 dark:border-zinc-800 border-t-2 border-t-orange-500 dark:border-t-yellow-400">
                    <div>
                        <div className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 dark:text-zinc-600 mb-0.5">Editar Item Manual</div>
                        <div className="text-zinc-900 dark:text-white font-semibold text-sm">{itemManualEmEdicao.itemData.nome_peca || 'Item sem nome'}</div>
                    </div>
                    <button onClick={() => setItemManualEmEdicao(null)} className="text-zinc-500 dark:text-zinc-600 hover:text-zinc-900 dark:hover:text-white transition-colors p-1">
                ...
                <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-100 dark:bg-black border border-zinc-200/80 dark:border-zinc-800 text-zinc-900 dark:text-white text-sm px-4 py-3 rounded-md dark:rounded-none focus:outline-none focus:border-orange-500 dark:focus:border-yellow-400 transition-colors"
                        />
                    </div>
                    <div className="flex gap-4">
                        <div className="flex-1">
                            <label className="text-[10px] uppercase font-mono text-zinc-500 dark:text-zinc-500 block mb-2">Tipo</label>
                    ...
                    {itemManualEmEdicao.itemData.tipo === 'area' && (
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <label className="text-[10px] uppercase font-mono text-zinc-500 dark:text-zinc-500 block mb-2">Acabamento</label>
                                <div className="px-4 py-3 border border-zinc-200/80 dark:border-zinc-800 font-mono text-xs text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-900">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                            <label className="text-[10px] uppercase font-mono text-zinc-500 dark:text-zinc-500 block mb-2">Total</label>
                            <div className="px-4 py-3 border border-orange-200 dark:border-yellow-400/20 bg-orange-50 dark:bg-yellow-400/5 font-mono text-sm text-orange-700 dark:text-yellow-400 font-semibold">
                ...
                <div className="px-6 py-4 border-t border-zinc-200/80 dark:border-zinc-800 flex gap-3">
                    <button onClick={() => setItemManualEmEdicao(null)} className="flex-1 border border-zinc-200/80 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 text-[11px] font-mono uppercase tracking-widest py-3 rounded-md dark:rounded-none hover:border-zinc-400 dark:hover:border-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">
                        Cancelar
                    </button>
                    <button onClick={onSalvar} className="flex-1 bg-orange-500 text-white dark:bg-yellow-400 dark:text-black text-[11px] font-bold uppercase tracking-widest py-3 rounded-md dark:rounded-none hover:shadow-[0_0_15px_rgba(249,115,22,0.3)] dark:hover:shadow-[0_0_15px_rgba(250,204,21,0.3)] transition-all flex items-center justify-center gap-2">

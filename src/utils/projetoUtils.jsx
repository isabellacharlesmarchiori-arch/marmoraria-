...
export const MEDICAO_STATUS = {
    ...
    aprovada:   { label: 'Aprovada',   color: 'text-green-700 dark:text-green-400',  border: 'border-green-300 dark:border-green-500/30',  bg: 'bg-green-50 dark:bg-green-400/5',   dot: 'bg-green-500 dark:bg-green-400'  },
};
